...
function reset()
{
    ...
    document.getElementById("third").innerHTML = '  <img onclick="scisor()" class="img" src="https://github.com/Ashish1322/rockPaperScisor/blob/master/scissor1.png?raw=true" alt="">'
}
